...
layui.define(['table', 'form'], function(exports) {
    ...
    table.render({
        elem: '#LAY-contractlist-manage'
        ,url:'contract/list'
        ,cols: [[
            {type: 'checkbox'}
            ,{field: 'id', width: 80, title: 'ID', align:'center'}
            ,{field: 'number', title: '合同编号', align:'center'}
            ,{field: 'title', title: '合同标题', minWidth: 100, align:'center'}
            ,{field: 'uploadUser', title: '上传人', minWidth: 100, align:'center'}
            ,{field: 'secret', title: '合同秘集', templet: '#secretTpl', align:'center'}
            ,{field: 'uploadtime', title: '上传时间', align:'center'}
            ,{field: 'isentity', title: '是否存在实体', templet: '#isentityTpl', align:'center'}
            ,{field: 'deposit_city', title: '存放地点', align:'center'}
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for(var i=0;i<opeations.length;i++){
                        ...
                        }else if(opeations[i].btnName=='合同录入'){
                            controlType='add';
    ...
    //用户管理监听工具条
    table.on('tool(LAY-contractlist-manage)', function(obj) {
        console.log(obj);
        var data = obj.data;
        if(obj.event === 'del') {
